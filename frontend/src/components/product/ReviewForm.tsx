  ...
  return (
    <form onSubmit={handleSubmit} className="p-6 rounded-2xl glass-card space-y-4 border border-slate-800">
      ...
      <button
        ...
        className="flex items-center space-x-2 bg-cyan-500 hover:bg-cyan-400 text-slate-950 font-bold text-sm px-5 py-2.5 rounded-xl shadow-lg shadow-cyan-500/20 transition-all hover:scale-105 active:scale-95 disabled:opacity-50"
      >
