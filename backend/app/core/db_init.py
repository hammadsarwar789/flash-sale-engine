    ...
    try:
        ...
        with db.engine.begin() as conn:
            if "postgres" in engine_name:
                ...
                conn.execute(text("ALTER TABLE products ADD COLUMN IF NOT EXISTS is_listed_on_shopify BOOLEAN NOT NULL DEFAULT FALSE;"))
                ...
                conn.execute(text("ALTER TABLE products ADD COLUMN IF NOT EXISTS sync_status VARCHAR(20) NOT NULL DEFAULT 'UNPUBLISHED';"))
